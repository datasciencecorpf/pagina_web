...
const BotInventarioAlmacenamiento = ({ title }) => {
    ...
    const init_distro = async (command) => {
        try {
            ...
            const response_project = await fetch(`/api/projects/${"p13"}/${command}`, requestOptions);
    ...
    return (
        <><Navbar />
            ...
            <h1 className='bot-name'>Bot para la actualización automática de Inventarios</h1>
            </div>
                ...
                <>
                    ...
                    <div className='btn-funct'>
                        <div className='card-icon'>
                            <img className="download-image" src={sapPNG} alt="Icono" />
                            <div className="btn-empezar">
                                <button className="button is-large is-warning m-1" onClick={() => init_distro("-m sap")}>
                                    <span>{"Inv. Sap"}</span>
                                </button>
                            </div>
                        </div>
                        <div  className='card-icon'>
                            <img className="download-image" src={excelPNG} alt="Icono" />
                            <div className="btn-empezar">

                                <button className="button is-large is-warning m-1" onClick={() => init_distro("-m excel")}>
                                    <span>{"Inv. Excel"}</span>
                                </button>
                            </div>
                        </div>
...
export default BotInventarioAlmacenamiento;